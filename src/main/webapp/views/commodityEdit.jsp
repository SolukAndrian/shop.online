...
<html>
<head>
    <title>Change of parameters</title>
    <meta charset="utf-8">
...
<div class="addCommodityContainer">
    <form action="/editCommodity" method="post" enctype="multipart/form-data">
        ...
        <input name="id" id="id" type="text" value="${com.id}" hidden>
        <br>
        <label for="name">Name:</label>
        <input name="name" id="name" type="text" value="${com.name}">
        <br>
        <label for="brand">Brand:</label>
        <input name="brand" id="brand" type="text" value="${com.brand}">
        <br>
        <label for="price">Price:</label>
        <input name="price" id="price" type="number" value="${com.price}">
        <br>
        <label for="description">Description:</label>
        <textarea rows="10" cols="45" name="description" id="description" value="${com.description}">${com.description}</textarea>
        <br><br>
        <label>Select photo</label>
        <input type="file" name="image" multiple accept="image/*" value="${com.image}" >
        <button type="submit" class="btn btn-primary">Change commodity</button>
    </form>
</div>
</body>
</html>
